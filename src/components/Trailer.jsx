export default function Trailer(){
    return (
        <section style={{backgroundImage: "url('/Trailer.png')"}} className="bg-contain min-h-screen lg:px-0 px-[10%] py-20 font-second flex items-center flex-col relative">
            <div className="lg:w-[1135px] m-auto">
                <div className="hidden lg:block absolute left-0 bottom-0 bg-gradient-to-r from-[#072834]/40">
                    <img src="/Kiri.png" className="w-[200px] invisible" alt=""/>
                </div>
                ...
                <div className="hidden lg:block absolute right-0 bottom-0 bg-gradient-to-l from-[#072834]/50 from-20%">
                    <img src="/Kiri.png" className="w-[200px] scale-[-1] invisible" alt=""/>
                </div>
            </div>
        </section>
    )
